...
-   Ensures the foreign keys for each table refer to the primary key of the related tables (e.g. customer_id and product_id on order table refer to the primary key of the latter tables). ![Prompt to Ensure Referential Integrity](images/MicrosoftTeams-image%20(4).png)
...
![GitHub Repository](images/MicrosoftTeams-image%20(2).png)
...
![Monthly Order and Finance Report](images/MicrosoftTeams-image%20(2).png){fig-align="center"}

![Top Sellers and Products](images/MicrosoftTeams-image%20(3).png)

The CSV files as the input for the database is stored in the Data_upload folder.

![Data Upload Folder](images/MicrosoftTeams-image%20(1).png)
...
![Version Control](images/MicrosoftTeams-image.png)
