...
-   Ensures the foreign keys for each table refer to the primary key of the related tables (e.g. customer_id and product_id on order table refer to the primary key of the latter tables). ![Prompt to Ensure Referential Integrity](images/MicrosoftTeams-image (4).png)
